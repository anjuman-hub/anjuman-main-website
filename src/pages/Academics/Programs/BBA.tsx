...
const BBAProgramDetail = () => {
  ...
  const program = {
    ...
    duration: '3 Years',
    seats: '120',
    fees: '₹2,50,000 per annum',
    placements: '92% placement rate with average package of 5.5 LPA',
    tagline: "Empowering Tomorrow's Business Leaders",
    overview: 'The Bachelor of Business Administration is a prestigious 3-year undergraduate degree designed to prepare students for leadership roles in diverse business sectors. Our curriculum combines business fundamentals with contemporary management practices.',
    description: 'Our BBA program is designed to equip students with comprehensive business knowledge and practical management skills. Through a blend of theoretical learning and real-world case studies, students develop expertise in finance, marketing, operations, and strategic management.',
    semesters: [
      { semester: 'Semester I', subjects: ['Business Communication', 'Business Environment', 'Principles of Management', 'Financial Accounting'] },
      { semester: 'Semester II', subjects: ['Microeconomics', 'Organizational Behavior', 'Cost Accounting', 'Business Mathematics'] },
      { semester: 'Semester III', subjects: ['Macroeconomics', 'Business Law', 'Financial Management', 'Human Resource Management'] },
      { semester: 'Semester IV', subjects: ['Marketing Management', 'Operations Management', 'Business Statistics', 'International Business'] },
      { semester: 'Semester V', subjects: ['Strategic Management', 'Corporate Finance', 'Entrepreneurship', 'Electives'] },
      { semester: 'Semester VI', subjects: ['Project Management', 'Business Ethics', 'Capstone Project', 'Career Preparation'] }
    ],
    highlights: [
      ...
      'Corporate guest lectures and workshops'
    ],
    specializations: ['Finance', 'Marketing', 'Human Resources', 'Entrepreneurship', 'International Business'],
    skills: ['Leadership', 'Financial Analysis', 'Strategic Planning', 'Communication', 'Problem Solving', 'Data Analysis'],
    career_paths: [
      { role: 'Management Consultant', company: 'Various Fortune 500 companies', salary: '6-10 LPA' },
      { role: 'Financial Analyst', company: 'Banks & Financial Institutions', salary: '5-8 LPA' },
      { role: 'Marketing Manager', company: 'FMCG & Retail', salary: '5-9 LPA' },
      { role: 'Entrepreneur', company: 'Own ventures', salary: 'Variable' }
    ],
    eligibility: ['12th Pass from recognized board', 'Minimum 50% aggregate marks', 'Valid entrance exam score (if applicable)', 'Age 18 years or above'],
  };
...
export default BBAProgramDetail;
