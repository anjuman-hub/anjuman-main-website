...
const BDesignProgramDetail = () => {
    ...
    const program = {
        ...
        duration: '4 Years',
        seats: '60',
        fees: '₹3,00,000 per annum',
        placements: '88% placement rate with average package of 6.2 LPA',
        tagline: 'Design the Future with Innovation',
        overview: 'The Bachelor of Design is a 4-year professional program that integrates artistic creativity with technical skills. Students learn to solve complex problems through design thinking and user-centric approaches across various disciplines like UI/UX, Product, and Visual Communication.',
        description: 'Our B.Des program focuses on hands-on learning and industry projects. Students explore contemporary design tools, sustainable practices, and emerging technologies to create impactful solutions for the global market.',
        semesters: [
            { semester: 'Semester I', subjects: ['Foundations of Design', 'Drawing & Visualization', 'Color Theory', 'History of Design'] },
            { semester: 'Semester II', subjects: ['Design Thinking', 'Typography', 'Material Exploration', 'Digital Tools I'] },
            { semester: 'Semester III', subjects: ['User Experience Design', 'Graphic Design', 'Photography', '3D Modeling'] },
            { semester: 'Semester IV', subjects: ['Interface Design', 'Service Design', 'Motion Graphics', 'Design Research'] },
            { semester: 'Semester V', subjects: ['Sustainable Design', 'Strategic Design', 'Professional Practice', 'Elective I'] },
            { semester: 'Semester VI', subjects: ['Dissertation', 'Industry Internship', 'Portfolio Development', 'Elective II'] },
            { semester: 'Semester VII', subjects: ['Advanced Specialization', 'Experimental Design', 'Project Management', 'Elective III'] },
            { semester: 'Semester VIII', subjects: ['Graduation Project', 'Degree Show', 'Professional Branding', 'Career Placement'] }
        ],
        highlights: [
            'State-of-the-art Design Labs and Studios',
            'Portfolio-based learning approach',
            'Regular workshops with international designers',
            'Focus on UI/UX and Digital Product Design',
            'Collaborations with leading design firms',
            'Annual Design Showcase event'
        ],
        specializations: ['UI/UX Design', 'Visual Communication', 'Product Design', 'Interaction Design', 'Animation'],
        skills: ['Design Thinking', 'Visual Prototyping', 'User Research', 'Creative Problem Solving', 'Digital Illustration', 'Project Documentation'],
        career_paths: [
            { role: 'UX/UI Designer', company: 'Tech Giants & Design Agencies', salary: '7-12 LPA' },
            { role: 'Product Designer', company: 'Startups & Manufacturing', salary: '6-10 LPA' },
            { role: 'Art Director', company: 'Media & Advertising Agencies', salary: '8-15 LPA' },
            { role: 'Design Researcher', company: 'Innovation Labs', salary: '6-9 LPA' }
        ],
        eligibility: ['12th Pass with any stream', 'Minimum 50% aggregate marks', 'DAT (Design Aptitude Test) Score', 'Portfolio Review & Interview'],
    };
...
export default BDesignProgramDetail;
