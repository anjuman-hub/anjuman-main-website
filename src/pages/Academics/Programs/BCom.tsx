...
const BComProgramDetail = () => {
    ...
    const program = {
        ...
        duration: '3 Years',
        seats: '150',
        fees: '₹1,60,000 per annum',
        placements: '88% placement rate with top accounting & finance firms',
        tagline: 'Building Future Commerce Professionals',
        overview: 'The Bachelor of Commerce program is designed to provide students with a comprehensive understanding of business management, accounting, economics, and finance. It prepares students for a variety of roles in the global business market.',
        description: 'Our B.Com program offers a deep dive into financial accounting, corporate law, business taxation, and auditing. With a curriculum aligned with professional certifications like CA, CS, and CMA, students gain the practical skills and theoretical grounding needed to excel in commerce and industry.',
        semesters: [
            { semester: 'Year 1', subjects: ['Financial Accounting', 'Business Mathematics', 'Microeconomics', 'Principles of Marketing', 'Business Communication', 'Environmental Studies'] },
            { semester: 'Year 2', subjects: ['Corporate Accounting', 'Company Law', 'Business Statistics', 'Indirect Taxation', 'Banking & Insurance', 'Entrepreneurship'] },
            { semester: 'Year 3', subjects: ['Cost & Management Accounting', 'Auditing & Assurance', 'Financial Management', 'Business Taxation', 'Project Work', 'Professional Elective'] }
        ],
        highlights: [
            'Comprehensive focus on Accounting and Finance',
            'Integration with professional certification exams (CA/CS/CMA)',
            'Industry-oriented internships and projects',
            'Qualified faculty with industry and academic expertise',
            'Regular workshops on tally and financial software',
            'Strong placement track record in top accounting firms'
        ],
        specializations: ['Accounting & Finance', 'Taxation', 'Banking & Insurance', 'International Business', 'Marketing Management'],
        skills: ['Financial Analysis', 'Auditing Techniques', 'Tax Planning', 'Business Strategy', 'Data Interpretation', 'Quantitative Aptitude'],
        career_paths: [
            { role: 'Accountant / Financial Analyst', company: 'Corporate & Audit Firms', salary: '5-9 LPA' },
            { role: 'Tax Consultant', company: 'Consulting Agencies', salary: '6-10 LPA' },
            { role: 'Bank Manager / Officer', company: 'Public & Private Banks', salary: '5-8 LPA' },
            { role: 'Entrepreneur / Business Leads', company: 'Own ventures / Startups', salary: 'Variable' }
        ],
        eligibility: ['12th Pass / PUC-II with Commerce or Science stream', 'Minimum 50% aggregate marks', 'Personal Interview', 'Entrance Test (if applicable)'],
    };
    ...
    return (
        <div className="pt-32">
            <div className="container mx-auto px-4">
                ...
                {/* Specializations */}
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-blue-900 mb-6">Commerce Specializations</h2>
