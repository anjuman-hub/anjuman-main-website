...
const AIMLProgramDetail = () => {
    ...
    const program = {
        ...
        overview: 'The B.Tech in AI & Machine Learning is designed to create experts in the rapidly evolving field of AI. The program covers deep learning, neural networks, robotics, and cognitive computing, empowering students to build intelligent systems for diverse applications.',
        description: 'Our AIML program focuses on the core principles of machine intelligence and its practical implementation. Students engage in intensive research and project-based learning, mastering the tools and techniques required to lead the AI revolution. From natural language processing to advanced computer vision, the curriculum is optimized for the needs of the modern tech landscape.',
        semesters: [
            { semester: 'Semester I & II', subjects: ['Mathematics I & II', 'Physics / Chemistry', 'Programming for Problem Solving', 'Probability & Statistics', 'Basics of AI', 'Design Thinking'] },
            { semester: 'Semester III & IV', subjects: ['Data Structures & Algorithms', 'Linear Algebra', 'Digital Systems', 'Object Oriented Programming', 'Computer Architecture', 'Discrete Structures'] },
            { semester: 'Semester V & VI', subjects: ['Machine Learning Foundations', 'Neural Networks', 'Natural Language Processing', 'Computer Vision', 'Database Systems', 'Operating Systems'] },
            { semester: 'Semester VII & VIII', subjects: ['Deep Learning', 'Reinforcement Learning', 'AI Ethics & Policy', 'Generative AI', 'Project Phase I & II', 'Cloud for AI'] }
        ],
        highlights: [
            'Advanced AI and Machine Learning Research Lab',
            'Curriculum designed with industry leaders',
            'Focus on Generative AI and Large Language Models (LLMs)',
            'Interdisciplinary projects across diverse domains',
            'Support for AI-based startups and patents',
            'Regular guest lectures by global AI experts'
        ],
        specializations: ['Deep Learning', 'Generative AI', 'Computer Vision', 'Speech Processing', 'Autonomous Systems'],
        skills: ['Deep Learning Frameworks (PyTorch/TensorFlow)', 'Neural Network Design', 'Computer Vision Algorithms', 'NLP Modeling', 'Cloud AI Services', 'Data Science Pipeline'],
        career_paths: [
            { role: 'AI Research Scientist', company: 'Global Tech Labs', salary: '12-25 LPA' },
            { role: 'Machine Learning Architect', company: 'Product MNCs', salary: '15-30 LPA' },
            { role: 'Data Science Lead', company: 'Analytics Firms', salary: '11-22 LPA' },
            { role: 'Computer Vision Engineer', company: 'Security & Entertainment', salary: '10-20 LPA' }
        ],
...
export default AIMLProgramDetail;
