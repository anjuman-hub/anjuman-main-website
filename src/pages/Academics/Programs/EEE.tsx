...
const EEEProgramDetail = () => {
    ...
    const program = {
        ...
        placements: '92% placement rate in core power & electronics sectors',
        tagline: 'Powering the Future Safely',
        overview: 'The B.Tech in Electrical & Electronics Engineering combines the study of power systems, electrical machines, and control systems with modern electronics and automation technologies.',
        description: 'Our EEE program focuses on both traditional power engineering and modern electronic systems. With specialized laboratories for electrical machines, power electronics, renewable energy, and control systems, students gain the expertise to design and manage efficient energy systems. The curriculum is optimized for the needs of the smart grid revolution, industrial automation, and the renewable energy transition.',
        semesters: [
            { semester: 'Semester I & II', subjects: ['Mathematics I & II', 'Physics / Chemistry', 'Engineering Graphics', 'Basics of Electrical & Electronics', 'Programming for Problem Solving', 'Design Thinking'] },
            { semester: 'Semester III & IV', subjects: ['Electric Circuit Analysis', 'Analog Electronics', 'Digital Electronics', 'Electrical Machines I', 'Electromagnetic Field Theory', 'Signals & Systems'] },
            { semester: 'Semester V & VI', subjects: ['Electrical Machines II', 'Power Systems I', 'Control Systems', 'Power Electronics', 'Microcontrollers', 'Linear Integrated Circuits'] },
            { semester: 'Semester VII & VIII', subjects: ['Power Systems II', 'Renewable Energy Systems', 'Smart Grids', 'Industrial Automation', 'Project Phase I & II', 'Professional Ethics'] }
        ],
        highlights: [
            'Advanced Electrical Machines and Power Layout Lab',
            'Focus on Renewable Energy and Smart Grid Technology',
            'Training in PLC, SCADA, and Industrial Automation',
            'Experience in electrical system design and simulation',
            'Regular industry visits to substations and power plants',
            'Strong preparation for public sector (PSU) and core engineering roles'
        ],
        specializations: ['Power Systems', 'Renewable Energy', 'Industrial Automation', 'Electric Vehicle Systems', 'Control & Instrumentation'],
        skills: ['Electrical Machine Design', 'Power System Analysis', 'PLC & SCADA Programming', 'Circuit Simulation (MATLAB/PSpice)', 'Control System Tuning', 'Renewable Energy Modeling'],
        career_paths: [
            { role: 'Power Systems Engineer', company: 'Public & Private Power Utilities', salary: '9-18 LPA' },
            { role: 'Automation Engineer', company: 'Manufacturing & Process Plants', salary: '8-15 LPA' },
            { role: 'Electrical Design Engineer', company: 'Consulting & Infrastructure MNCs', salary: '7-13 LPA' },
            { role: 'Grid Operations Specialist', company: 'Smart Grid Developers', salary: '8-16 LPA' }
        ],
...
export default EEEProgramDetail;
