...
const ECEProgramDetail = () => {
    ...
    const program = {
        ...
        duration: '4 Years',
        seats: '90',
        fees: '₹3,25,000 per annum',
        placements: '94% placement rate with average package of 7.5 LPA',
        tagline: 'Connecting the World Through Technology',
        overview: 'The B.Tech in Electronics & Communication Engineering focuses on the principles of communications, signal processing, and electronics to design systems that connect people and machines across the globe.',
        description: 'Our ECE program bridges the gap between hardware and software, covering advanced topics in VLSI design, embedded systems, satellite communications, and signal processing. With state-of-the-art laboratories and a curriculum aligned with the latest industry standards in IoT and 5G technology, students are prepared to innovate in sectors ranging from telecommunications to aerospace and robotics.',
        semesters: [
            { semester: 'Semester I & II', subjects: ['Mathematics I & II', 'Physics / Chemistry', 'Basics of Electrical Engineering', 'C Programming', 'Digital Systems', 'Engineering Graphics'] },
            { semester: 'Semester III & IV', subjects: ['Analog Electronics', 'Signals & Systems', 'Network Analysis', 'Microcontrollers', 'Control Systems', 'Electromagnetic Theory'] },
            { semester: 'Semester V & VI', subjects: ['Digital Communication', 'VLSI Design', 'Digital Signal Processing', 'Antennas & Propagation', 'Computer Communication Networks', 'Embedded Systems'] },
            { semester: 'Semester VII & VIII', subjects: ['Optical Fiber Communication', 'Satellite Communication', 'Wireless & Mobile Comm', 'IoT & Smart Systems', 'Project Phase I & II', 'Power Electronics'] }
        ],
        highlights: [
            'Advanced VLSI and Embedded Systems Labs',
            'Center of Excellence for IoT and Wireless Communication',
            'Research focus on Signal Processing and Robotics',
            'Industry certifications in Embedded Systems and networking',
            'Regular workshops on PCB design and FPGA programming',
            'Partnerships with leading telecom and semiconductor companies'
        ],
        specializations: ['VLSI Design', 'Embedded Systems', 'Signal Processing', 'Wireless Communication', 'IoT'],
        skills: ['Circuit Design & Analysis', 'Embedded C/C++', 'FPGA Programming', 'MATLAB/Simulink', 'VLSI Design Tools (Cadence/Mentor)', 'Network Protocol Design'],
        career_paths: [
            { role: 'Embedded Systems Engineer', company: 'Automotive & Consumer Electronics', salary: '9-18 LPA' },
            { role: 'VLSI Design Engineer', company: 'Semiconductor Global Leaders', salary: '12-25 LPA' },
            { role: 'Network Planning Engineer', company: 'Telecom Giants', salary: '8-14 LPA' },
            { role: 'Signal Processing Specialist', company: 'Defense & Space Research', salary: '10-20 LPA' }
        ],
...
export default ECEProgramDetail;
